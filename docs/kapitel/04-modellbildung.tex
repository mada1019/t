...
Daher wird im Folgenden zunächst ein simples Raummodell gebildet, dass anschließend sukzessive erweitert und damit die Komlpexität des Modells schrittweise erhöht wird, bis eine ausreichende Beschreibung der Realität mit dem Modell möglich ist.
...
Sonneneinstrahlung komplexe Berechnungen wie in Kapitel gegeben. Um Komplexität des Modells zu schonen und unstetigkeiten zu vermeiden, wurde ein eigenes Skript erstellt in Python mit pysolar, das eine effiziente und sehr exakte berechnung der benötigten Größen implementiert hat.
