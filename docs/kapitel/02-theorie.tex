...
Die Einführung wird stark an die Struktur nach \cite{schn06} anlehnen.
...
Auf dem Gebiet der Buskommunikation entspricht wird eine Information oder Nachricht codiert. Es werden stets Transparente Codes betrachtet, Welche bitorientiert sind. Dabei sind jegliche Kombination von Bits erlaubt und man kann allein Aus der Folge der Blitz nicht auf einen Fehler schließen.
