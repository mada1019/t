...
Um die vier Temperatursensoren über den Webthermograph8x auszulesen wurde das Python Paket httlib genutzt. Die Abfrage der einzelnen Temperatursensoren über das HTTP Protokoll wurde in einer eigenen Klasse SensorsHttp implementiert und nutzt das HTTPConnection Objekt aus der httplib. Die gesamte folgende Progammierung erfolgt sehr stark objektorientiert und versucht eine klare Struktur und Wiederverwendbarkeit der Methoden und Klassen zu gewährleisten. Die konkrete Umsetzung der Klasse ist in Listing \ref{lst:webtemp} dargestellt.
