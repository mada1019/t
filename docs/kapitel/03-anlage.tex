...
\begin{itemize}
	...
	\item Des Weiteren soll die Anlage möglichst flexibel ansteuerbar und erweiterbar sein, damit der Grad der Kompliziertheit anpassbar ist und die Anlage um weitere Funktionen oder Features ergänzt werden kann.
...
\begin{itemize}[itemsep=0pt,topsep=0pt,leftmargin=6mm]
...
\begin{itemize}[itemsep=0pt,topsep=1pt,leftmargin=7mm]
	\item Modellbildung,
	\item Kommunikation technischer Systeme,
	\item und Modellprädiktive Regelung.
\end{itemize}
 	& \multirow{2}{\hsize}{
\begin{minipage}[t]{0.57\textwidth}
\begin{itemize}[itemsep=0pt,topsep=0pt,leftmargin=6mm]
	\item Die Kompliziertheit ist notwendig, darf jedoch nicht zu hoch gewählt werden.
	\item Es sind möglichst wenige thematische Überschneidungen erwünscht und es wird eine klare Struktur mit möglichst scharfer Trennung notwendig.
\end{itemize}
\end{minipage}
}  \\
...
Modellprädiktive Regelung mit JModelica.org & \multirow{3}{\hsize}{
\begin{minipage}[t]{0.57\textwidth}
\begin{itemize}[itemsep=0pt,topsep=0pt,leftmargin=6mm]
\item Die Kommunikation erfolgt über die Modbus~RTU und Modbus~TCP Protokolle gemäß deren Spezifikationen.
\item Durch die Kommunikation mit Modbus~TCP ist die Ansteuerung der innerhalb des gesamten lokalen Netzwerks möglich.
\item Die Modellbildung erfolgt in Modelica.
\item Die Kompabilität aller Softwareschnittstellen ist in Python durch verschiedene, bereits bestehende Pakete gegeben.
\end{itemize}
\end{minipage}
}  \\
...
\begin{itemize}[itemsep=0pt,topsep=1pt,leftmargin=7mm]
	\item die Variation der Steuerungsparameter,
	\item den Einsatz verschiedener Regelungsmethodiken,
	\item und den Einsatz verschiedener Algorithmen.
\end{itemize}
...
Hohe Funktionalität und Robustheit & Einfache Anwendung mit geringer Störanfälligkeit \\
