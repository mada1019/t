...
Das zweite Subnetz ist ein serielles RS 485 Netzwerk und erlaubt den Einsatz des Modbus RTU Protokolls. Die beiden Netzwerke werden durch ein Gateway miteinander verbunden, welches die Übersetzung Kommunikation in beiderlei Richtungen übernimmt. Die Übersetzung beinhaltet im Detail das Umwandeln der elektrischen Signale und der verschiedenen Modbus Telegramme ineinander.

Im dritten Subnetz wird über analoge Spannungssignale zwischen 0 und 10~V kommuniziert, welche von einem Signalwandler erzeugt werden. Der Signalwandler wiederum ist kein Gateway, da die Spannungssignale nicht implizit übersetzt, sondern explizit durch Modbus RTU Befehlstelegramme festgelegt werden. Eine graphische Zusammenfassung der Netzwerkarchitektur ist in \ref{fig:netzwerk} abgebildet.
...
Die Raumtemperatur kann einfach und günstig durch Raumtemperaturfühler gemessen werden. Weiterhin soll der gemessene Wert über eine der beiden Modbus Schnittstellen dem Controller zur Verfügung gestellt werden. Innerhalb der Anlage kommen zwei \textsc{THERMASGARD RTM1-Modbus} Raumtemperaturfühler von \textsc{S+S Regeltechnik} zum Einsatz, weil sich dieser durch weitere Eigenschaften auszeichnet. Diese und weitere Eigenschsafte lassen sich dem Datenblatt im Anhang \ref{att:rtm1} entnehmen.
%Evtl Bild oder Übersicht

%Here We GO!!!!!


Die Positionierung ist in Abbildung REFXXXX graphisch dargestellt und erfolgt auf einer raummittig gedachten Achse in nord-südlicher Richtung, jeweils am Ende der Schreibtische. Einer in Richtung der Fenster, der andere gegenüber am Ende der Schreibtische.
